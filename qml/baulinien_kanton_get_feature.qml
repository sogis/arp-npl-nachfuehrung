...
<qgis simplifyLocal="1" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.10.11-A Coruña" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="0" readOnly="0" minScale="1e+08">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0">
    <rules key="{5139a858-15bb-4bf3-b85f-20b6509094b2}">
      <rule symbol="0" filter="attribute(get_feature( 'erschlssngsplnung_typ_erschliessung_linienobjekt_d622e34c_2177_412d_85ea_7c4ff7167308','t_id',  &quot;typ_erschliessung_linienobjekt&quot; ),'typ_kt') = 'E711_Baulinie_Strasse_kantonal'" key="{483bdd17-06bb-4ebe-8a8d-24ebef4eee80}" label="Baulinie Strasse kantonal"/>
      <rule symbol="1" filter="attribute(get_feature( 'erschlssngsplnung_typ_erschliessung_linienobjekt_d622e34c_2177_412d_85ea_7c4ff7167308','t_id',  &quot;typ_erschliessung_linienobjekt&quot; ),'typ_kt') = 'E712_Vorbaulinie_kantonal'" key="{85d2bd9c-f22f-4440-b8d7-a226c6373069}" label="Vorbaulinie kantonal"/>
      <rule symbol="2" filter="attribute(get_feature( 'erschlssngsplnung_typ_erschliessung_linienobjekt_d622e34c_2177_412d_85ea_7c4ff7167308','t_id',  &quot;typ_erschliessung_linienobjekt&quot; ),'typ_kt') = 'E713_Gestaltungsbaulinie_kantonal'" key="{f1f349f7-2e45-4cd0-8a44-eb0b8e253c78}" label="Gestaltungsbaulinie kantonal"/>
      <rule symbol="3" filter="attribute(get_feature( 'erschlssngsplnung_typ_erschliessung_linienobjekt_d622e34c_2177_412d_85ea_7c4ff7167308','t_id',  &quot;typ_erschliessung_linienobjekt&quot; ),'typ_kt') = 'E714_Rueckwaertige_Baulinie_kantonal'" key="{2d895964-a6fa-4096-972c-2b56f408b2c0}" label="Rückwärtige Baulinie kantonal"/>
      <rule symbol="4" filter="attribute(get_feature( 'erschlssngsplnung_typ_erschliessung_linienobjekt_d622e34c_2177_412d_85ea_7c4ff7167308','t_id',  &quot;typ_erschliessung_linienobjekt&quot; ),'typ_kt') = 'E715_Baulinie_Infrastruktur_kantonal'" key="{acda5001-ce6b-48bc-a412-556cf78aac5a}" label="Baulinie Infrastruktur kantonal"/>
      <rule symbol="5" filter="attribute(get_feature( 'erschlssngsplnung_typ_erschliessung_linienobjekt_d622e34c_2177_412d_85ea_7c4ff7167308','t_id',  &quot;typ_erschliessung_linienobjekt&quot; ),'typ_kt') = 'E719_weitere_nationale_und_kantonale_Baulinien'" key="{d20a6d3a-f721-4ece-ac27-0838ed248a23}" label="weitere nationale und kantonale Baulinien" description="7191-7199 weitere nationale und kantonale Baulinien"/>
    </rules>
    <symbols>
  ...
  <attributeactions>
    ...
    <actionsetting type="5" shortTitle="" capture="0" id="{9d15e3db-b356-407e-a673-e31fdea4aa43}" action="[% &quot;dok_textimweb&quot; %]" icon="" name="Dokument öffnen" notificationMessage="" isEnabledOnlyWhenEditable="0">
